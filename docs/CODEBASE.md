...
| [day_workout.tscn](../scenes/days/day_workout.tscn) | [7] | DayManager | barbell pickup then mash `jump` vs KikiSwarm (creep-back, pumps bar); kiki circle blocks the head; fail sunset or `kiki` | loose at (560,306) | "Walk to the barbell and press E." then mash W/↑ |
| [day_mirror.tscn](../scenes/days/day_mirror.tscn) | [8] | DayManager | jump kikis from the head (right-down-left); reaching the glass (`grab_radius` 56) throws it; look-at-glass inverts walk + jump (S / ↓ hops); fail sunset or `kiki` | on platform at (572,258) | "Jump the thoughts. E at the glass throws it. Arrows flip with the head." |
