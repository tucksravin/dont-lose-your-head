...
| [day_panic_still.tscn](../scenes/days/day_panic_still.tscn) + [.gd](../scenes/days/day_panic_still.gd) | [0] | DayManager | stand still until panic hits 0 (body+mind); fail = panic max, pit, or sunset; kiki cloud | loose in the tree canopy (592,246); sighs and falls off the cliff | "Hold still. Panic to zero…" |
