...
```mermaid
flowchart LR
  Ti["title.tscn<br/>(landing screen, boot)"] -- "button" --> I["intro.tscn<br/>(cutscene: kikis panic the head off)"]
  I -- "Game.start_days()" --> T0["transition_bird.tscn<br/>(chase it down; a bird takes it)"]
