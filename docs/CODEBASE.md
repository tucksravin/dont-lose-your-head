...
| [day_panic.tscn](../scenes/days/day_panic.tscn) + [.gd](../scenes/days/day_panic.gd) | [2] | DayManager | E on the floor button (body+mind); fail = panic max or kiki or sunset; kiki cloud + flying kikis | `caged = true` hanging at (520,168), glasses on | "E at the button frees the cage…" |
