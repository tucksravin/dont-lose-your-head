...
| **A0** | Art direction kickoff — palette = Gooseberry Ghost (8); body base = tbbk CC0 skeleton, recoloured (decided); head = ours 16×16 (+ outline); kiki/bouba sketch; what the sun looks like; which placeholders get swapped first. Tone: silly-spooky | Tucker | D6 ✔ | S | a one-screen style sheet in `assets/` everyone can see |
